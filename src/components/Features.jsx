...
export function Features() {
  return (
    <section className="px-5 md:px-20 xl:px-28 pt-24 pb-40 text-white">
      <span data-aos="fade-up" className="features-gradient-text uppercase border border-[#59D3FF] rounded-[31.25rem] p-[0.625rem] font-aspekta-medium">
        KazeBot’s Features
      </span>
      <h1 data-aos="fade-up" className="mt-[1.72rem] text-3xl lg:text-5xl font-aspekta-light-250">
