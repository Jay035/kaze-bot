...
export default function Trade() {
  return (
    <section className="text-white px-5 md:px-20 xl:px-28 pt-32 pb-[4.7rem] flex flex-col items-center text-center">
      <h1 className="text-3xl md:text-5xl font-aspekta-light-250">
        All Fees Go To Buying $KBT
      </h1>
      <p className="mt-8 lg:text-2xl tracking-[-0.03rem] max-w-[58rem] mb-8 lg:mb-16 font-aspekta-light-250">
